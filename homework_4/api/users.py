...
from homework_4.api.contracts import RegisterUserRequest, UserResponse
from homework_4.api.utils import AdminDep, AuthorDep, UserServiceDep
from homework_4.core.users import UserInfo, UserRole
...
async def promote_user(id: Annotated[int, Query()], _: AdminDep, user_service: UserServiceDep):
