...
from homework_4.core.users import UserEntity, UserInfo, UserRole, UserService, password_is_longer_than_8
...
def requires_author(credentials: CredentialsDep, user_service: UserServiceDep) -> UserEntity:
